...
describe("BookDetails", () => {
  ...
  it("shows contributors with mapped roles", () => {
    const contributors = wrapper.find(".contributors");
    expect(contributors.text()).to.equal(
      "Contributors: contributor 1 (Narrator)"
    );
  });
